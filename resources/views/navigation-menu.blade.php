<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center" style="height: 100%;width:100%;">
                    <a href="{{ route('dashboard') }}">
                        <x-jet-application-mark class="block h-25 w-25 " />
                    </a>
                </div>
                ...
                <div class="hidden space-x-10 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('addproducts') }}" :active="request()->routeIs('addproducts')" style="width:120px;">
                        {{ __('Add Products') }}
                    </x-jet-nav-link>
                </div>
            </div>
